...
void draw()
{
    ...
    SDL_SetRenderDrawColor(gRenderer, 30, 300, 0xFF, 10);
    SDL_Rect fillRect2 = {x+80, y+110, 50, 50};
    SDL_RenderFillRect (gRenderer, &fillRect2);

    SDL_SetRenderDrawColor(gRenderer, 0xFF, 80, 10, 0xFF);
    SDL_Rect fillRect3 = {x+400, y-20, 50, 50};
